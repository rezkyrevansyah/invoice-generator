import type { FreelancerData, InvoiceFormData, SettlementFormData, ReimbursementOnlyFormData } from './types';
...
export const defaultReimbursementFormData: ReimbursementOnlyFormData = {
  reimbursementNumber: '',
